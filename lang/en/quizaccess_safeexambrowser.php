...
$string['allowedconfigkeys_help'] = 'In this box you can enter the allowed SEB config keys. Unlike browser exam keys, config keys are platform-independent and do not change when the SEB version is updated. If no keys are entered, then no config key check is performed for this quiz.';
$string['allowedconfigkeysdistinct'] = 'The config keys must all be different.';
$string['allowedconfigkeyssyntax'] = 'You must enter the allowed config keys one per line. A config key should be a 64-character hex string.';
$string['allowedkeys_adv'] = 'Keys are an advanced setting';
$string['allowedkeys_adv_desc'] = 'If this option is on, then the list of allowed browser keys and config keys is an advanced field on the quiz settings form.';
